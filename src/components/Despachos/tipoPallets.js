...
const TipoPalletsGrid = () => {

  const lang = useSelector(state => state.ux.language);

  var columns = [
    { field: "idTipoPallets", title: "Id", width: "80px", editable: false, filterable: false, hidden: true },
    { field: "tipoPallets1", title: "Tipo Pallets", width: "220px" },
...
export default TipoPalletsGrid
